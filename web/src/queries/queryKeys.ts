export class QueryKeys {
  ...
  static getAddressTransactionsKey = (
    address: string,
    skip: number,
    limit: number
  ) => ['ADDRESS_TRANSACTIONS', address, skip, limit];
  static getAddressDeploymentsKey = (
    address: string,
    skip: number,
    limit: number,
  ...
  static getProviderGraphKey = (snapshot: string) => [
    'PROVIDER_GRAPH',
    snapshot,
  ];
  static getTemplateKey = (id: string) => ['SDL_TEMPLATES', id];
  static getUserTemplatesKey = (username: string) => [
    'USER_TEMPLATES',
    username,
  ];
  static getUserFavoriteTemplatesKey = (userId: string) => [
    'USER_FAVORITES_TEMPLATES',
    userId,
  ];
  ...
  static getAllowancesIssued = (address: string) => [
    'ALLOWANCES_ISSUED',
    address,
  ];
  static getAllowancesGranted = (address: string) => [
    'ALLOWANCES_GRANTED',
    address,
  ];

  // Deploy
  static getDeploymentListKey = (address: string) => [
    'DEPLOYMENT_LIST',
    address,
  ];
  static getDeploymentDetailKey = (address: string, dseq: string) => [
    'DEPLOYMENT_DETAIL',
    address,
    dseq,
  ];
  static getAllLeasesKey = (address: string) => ['ALL_LEASES', address];
  static getLeasesKey = (address: string, dseq: string) => [
    'LEASE_LIST',
    address,
    dseq,
  ];
  static getLeaseStatusKey = (dseq: string, gseq: number, oseq: number) => [
    'LEASE_STATUS',
    dseq,
    gseq,
    oseq,
  ];
  static getBidListKey = (address: string, dseq: string) => [
    'BID_LIST',
    address,
    dseq,
  ];
  ...
  static getProviderStatusKey = (providerUri: string) => [
    'PROVIDER_STATUS',
    providerUri,
  ];
  static getNetworkCapacity = () => ['NETWORK_CAPACITY'];
  static getProviderActiveLeasesGraph = (providerAddress: string) => [
    'PROVIDER_ACTIVE_LEASES_GRAPH',
    providerAddress,
  ];
