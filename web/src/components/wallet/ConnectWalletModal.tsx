...
import { CustomDialogTitle } from '../../components/shared/CustomDialogTitle';
import Paper from '@mui/material/Paper';
import Box from '@mui/material/Box';
import { Alert, CircularProgress, Typography } from '@mui/material';
import { useKeplr } from '../../context/KeplrWalletProvider/KeplrWalletProvider';
...
export const ConnectWalletModal: React.FunctionComponent<Props> = ({
  ...
  const onConnectKeplrClick = async (
      ...
      <CustomDialogTitle onClose={onClose}>
        ...
        {isConnectingWallet && (
          <CircularProgress
            size="1rem"
            color="secondary"
            className={classes.connectWalletLoading}
          />
        )}
      </CustomDialogTitle>
      <DialogContent className={classes.content}>
        ...
        >
          ...
          <Box sx={{ padding: '0 1rem' }}>
            ...
            <Typography variant="body2">
              {isKeplrInstalled ? 'Keplr Browser Extension' : keplrUrl}
            </Typography>
          </Box>
        </Paper>
        ...
        <Box sx={{ marginTop: '1rem' }}>
          <Alert severity="info" icon={false} sx={{ fontSize: '.7rem' }}>
            ...
            understand our{' '}
            <Link href={UrlService.termsOfService()}>Terms of Service.</Link>
          </Alert>
        </Box>
      </DialogContent>
    </Dialog>
