    ...
    <>
      ...
      <div className="flex flex-grow">
        <div className="mx-auto flex w-full flex-grow flex-col transition-all xl:max-w-[1360px] 4xl:max-w-[1760px]">
          <div className="relative mb-5 flex flex-grow items-center justify-center ltr:md:left-0 rtl:md:right-0 rtl:md:pr-6 lg:mb-0 lg:h-[calc(100%-140px)] lg:w-full xl:pb-0 rtl:xl:pr-0 2xl:pt-0 ltr:2xl:pl-0 3xl:fixed 3xl:w-[calc(100%-554px)] ltr:4xl:pl-0 rtl:4xl:pr-0">
          ...
          <div className="relative flex w-full flex-grow flex-col justify-between ltr:md:ml-auto rtl:md:mr-auto rtl:md:pr-8 lg:min-h-[calc(100vh-96px)] lg:w-full ltr:lg:pl-0 rtl:lg:pr-12 rtl:xl:pr-0 3xl:w-[592px] ltr:3xl:pl-20 rtl:3xl:pr-20">
            <div className="block">
              <div className="block">
