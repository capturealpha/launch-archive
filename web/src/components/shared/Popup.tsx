...
export const Popup: React.FC<PopupProps> = (props) => {
  ...
  switch (props.variant) {
    ...
    case 'message':
      component.push(
        <DialogActions
          key="DialogActions"
          className={classes.genericDialogActions}
        >
          <Button
            variant="contained"
            color="secondary"
          ...
          >
            {isLoading ? (
              <CircularProgress
                ...
                sx={{
                  color:
                    !isLoadingColor && rest.color === 'secondary'
  ...
  const handleOnClose = (event, reason) => {
    if (
      (props.enableCloseOnBackdropClick || reason !== 'backdropClick') &&
      props.onClose
    ) {
      props.onClose(event, reason);
    }
  ...
  return (
    <Dialog
      ...
      classes={{
        paper: `${
          props.fixedTopPosition &&
          props.fixedTopPositionHeight &&
          classes.fixedTopPosition
        } ${getFixedPositionHeightClass()} ${classes.paper}`,
      }}
      {...dialogProps}
