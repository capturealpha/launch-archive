...
import { BidDto } from '../types/deployment';
import {
  BasicAllowance,
  MsgGrant,
  MsgGrantAllowance,
...
export class TransactionMessageData {
  ...
  static getCreateCertificateMsg(
    address: string,
    crtpem: string,
    pubpem: string
  ) {
  ...
  static getDepositDeploymentMsg(
    address: string,
    dseq: string,
  ...
  static getGrantBasicAllowanceMsg(
    granter: string,
    grantee: string,
    spendLimit: number,
    denom: string,
